    ...
    <br></br>
        ...
        <div className='form-group'>
            <div className='names'>
                ...
                <input type='text'  name='firstName' className='fname' id='first_name' placeholder='Enter your first name'/>
                </div>
                <div className='fdiv'>
                <label htmlFor='lastName' className='l'>Last Name </label> <br />
                <input type='text' name='lastName' className='fname' id='last_name' placeholder='Enter your last name'/><br />
                </div>
            </div>
                <label htmlFor='email' className='l'>Email </label> <br />
                <input type='email' name='email' className='email' id='email' placeholder='yourname@email.com'/><br />
              
              <label htmlFor='message' className='l'>Message </label> <br />
              <textarea type='textarea' name='message' id='message' placeholder="Send me a message and I'll reply you as soon as possible..."/><br />
